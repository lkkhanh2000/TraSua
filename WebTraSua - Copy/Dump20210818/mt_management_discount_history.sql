...
CREATE TABLE `discount_history` (
  `iddiscount_history` int NOT NULL AUTO_INCREMENT,
  `iddiscount` int NOT NULL,
  PRIMARY KEY (`iddiscount_history`),
  KEY `fk_history_discount_idx` (`iddiscount`),
  CONSTRAINT `fk_history_discount` FOREIGN KEY (`iddiscount`) REFERENCES `discount` (`iddiscount`)
